...
public class XkeyWidgetProvider extends AppWidgetProvider {
	...
	public static String ACTION_PLAY = "xk3y.dongle.android.action.1x4.PLAY_GAME";
	public static String ACTION_PREV = "xk3y.dongle.android.action.1x4.PREV_GAME";
	public static String ACTION_NEXT = "xk3y.dongle.android.action.1x4.NEXT_GAME";
	public static String ACTION_RELOAD= "xk3y.dongle.android.action.1x4.RELOAD_GAME";
