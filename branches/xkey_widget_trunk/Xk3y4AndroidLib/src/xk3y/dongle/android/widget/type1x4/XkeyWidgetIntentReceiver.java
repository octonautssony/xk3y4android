...
public class XkeyWidgetIntentReceiver extends BroadcastReceiver {
	...
	public static int  WIDGET_LAYOUT = R.layout.xkey_widget_layout_1x4;
	
	public static TypeSizeWidget WIDGET_SIZE = TypeSizeWidget.TYPE_1X4;
	...
	public void onReceive(Context context, Intent intent) {
		...
		if(intent.getAction().equals("xk3y.dongle.android.action.1x4.PREV_GAME")){
			updateWidgetPrevGameListener(context);
		}else if (intent.getAction().equals("xk3y.dongle.android.action.1x4.NEXT_GAME")){
			updateWidgetNextGameListener(context);
		}else if (intent.getAction().equals("xk3y.dongle.android.action.1x4.PLAY_GAME")){
			updateWidgetPlayGameListener(context);
		}else if (intent.getAction().equals("xk3y.dongle.android.action.1x4.RELOAD_GAME")){
